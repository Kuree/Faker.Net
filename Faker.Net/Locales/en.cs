...
namespace Faker.Net.Locales
{
    internal class En : Locale
    {
        ...
        {
            if (this.FemaleLastName != null && this.MaleLastName != null)
            {
                if (Random.RandomProxy.NextBool())
                    return Random.Selector.GetRandomItemFromList<string>(this.FemaleLastName);
                else
                    return Random.Selector.GetRandomItemFromList<string>(this.MaleLastName);
            }
            return Random.Selector.GetRandomItemFromList<string>(this.LastName);
        }

        public virtual string GetFirstName()
        {
            if(this.FemaleFirstName != null && this.MaleFirstName != null)
            {
                if (Random.RandomProxy.NextBool())
                    return Random.Selector.GetRandomItemFromList<string>(this.FemaleFirstName);
                else
                    return Random.Selector.GetRandomItemFromList<string>(this.MaleFirstName);
            }
            return Random.Selector.GetRandomItemFromList<string>(this.FirstName);
        }

        internal virtual string GetNameSuffix()
        {
            return Random.Selector.GetRandomItemFromList<string>(this.NameSuffix);
        }

        internal virtual string GetNamePrefix()
        {
            return Random.Selector.GetRandomItemFromList<string>(this.NamePrefix);
        }

        public virtual string FindName(string firstName, string lastName)
        {
